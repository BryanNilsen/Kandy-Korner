...
const Register = (props) => {
  ...
  const handleRegister = () => {
    if (
      ...
      APIManager.findUserByEmail(credentials.email).then((res) => {
        if (res.length === 0) {
          APIManager.postResource("employees", credentials).then((emp) => {
  ...
  useEffect(() => {
    APIManager.getResource("locations").then((res) => setLocations(res));
  }, []);
      ...
      <div className="center">
        ...
        <form>
          ...
          <fieldset>
            ...
            <input id="email" name="email" type="text" onChange={handleInput} />
          </fieldset>
          <fieldset>
          ...
          <fieldset>
            ...
            <input id="phone" name="phone" type="text" onChange={handleInput} />
          </fieldset>
          <fieldset>
